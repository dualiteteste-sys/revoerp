...
import { Save, X, CreditCard, Paperclip, Tag, Loader2 } from 'lucide-react';
...
interface ContaReceberFormProps {
  ...
  onSave: (data: Partial<ContaReceber>) => void;
  onCancel: () => void;
  loading: boolean;
}
...
export const ContaReceberForm: React.FC<ContaReceberFormProps> = ({ conta, onSave, onCancel, loading }) => {
